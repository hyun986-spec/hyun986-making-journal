...
![alt text](week1-collect-data.png)
...
![alt text](week1-visualise.png)
*(Figure 2. Group portrait)*

---
### Step 3: Decode 
![alt text](week1-other-group-portrait.png)
*(Figure 3. Other group portrait)*

<br>

**Content written on the Post-it notes:**<br>

**What can you learn about the people in this group from their data portrait?**<br>
...
**What questions do you have for them?**<br>
...
![alt text](week1-data1.png)
![alt text](week-data2.png) 
*(Figure 5, 6. Raw Data: Recorded Instances of 'Spacing Out')*

![alt text](week1-data3.png) 
...
![alt text](<week1-design-your visualisation .png>)
