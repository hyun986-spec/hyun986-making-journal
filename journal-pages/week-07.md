...
### 1.1 Addressing the Technical Gaps Identified in the Week 6 Roadmap
...
![alt text](../assets/week-07/week7-6.png)
*(Figure: App recommended by my tutor for connecting LEDs to a physical prototype)*
